...
specializes : LLMs · RAG · Agentic AI · Computer Vision · MLOps · Full-Stack AI
...
### 💼 Record — POS & Analytics Platform
Real-time gold/silver price scraping, pricing calculations & analytics dashboards for goldsmith retailers.

`FastAPI` `PostgreSQL` `NumPy` `Matplotlib` `React`
